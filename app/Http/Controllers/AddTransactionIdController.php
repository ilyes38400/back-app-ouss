...
class AddTransactionIdController extends Controller
{
    public function addTransactionId(Request $request)
    {
        ...
        // Mettre à jour la colonne uniqueIdentifier avec le transactionId
        $subscription->uniqueIdentifier = $transactionId;
        $subscription->save();
        ...
        return response()->json([
            ...
            'data'   => [
                ...
                'attributes' => [
                    ...
                    'uniqueIdentifier' => $subscription->uniqueIdentifier,
                ],
            ]
        ], 200);
    }
