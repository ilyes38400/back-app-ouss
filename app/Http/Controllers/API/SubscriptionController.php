    ...
    public function createSubscription(Request $request)
{
   ...
   // $transactionDate = \Carbon\Carbon::createFromTimestamp($request->input('transaction_date'));
    ...
    try {
        $subscription = Subscription::updateOrCreate(
            ...
            [
                'platform' => $platform,
                'platform_subscription_id' => $purchaseId,
                'product_id' => $productId,
            //    'subscription_start_date' => $transactionDate,
                'status' => 'active',
            ]
        );
        ...
        return response()->json(['message' => 'Subscription created/updated successfully'], 200);
    } catch (\Exception $e) {
        return response()->json(['message' => 'Failed to create/update subscription', 'error' => $e->getMessage()], 500);
    }
}
