...
class WorkoutDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('is_monthly_program', function($query) {
                $badge = $query->is_monthly_program ? 'success' : 'secondary';
                $text = $query->is_monthly_program ? 'Oui' : 'Non';
            ...
            ->rawColumns(['action','status','is_monthly_program']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            ['data' => 'is_monthly_program', 'name' => 'is_monthly_program', 'title' => 'Programme du mois'],
