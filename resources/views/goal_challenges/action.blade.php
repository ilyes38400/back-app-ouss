{{-- resources/views/goal_challenges/action.blade.php --}}
@php $auth_user = auth()->user(); @endphp

<div class="d-flex align-items-center">
    {{-- Bouton “Modifier” --}}
        <a class="btn btn-sm btn-icon btn-success me-2"
           href="{{ route('goal-challenges.edit', $id) }}"
           data-bs-toggle="tooltip"
           title="{{ __('message.update_form_title', ['form' => __('message.goal_challenge')]) }}">
    ...
    {{-- Bouton “Supprimer” --}}
        <a class="btn btn-sm btn-icon btn-danger"
           ...
           title="{{ __('message.delete_form_title', ['form' => __('message.goal_challenge')]) }}"
        ...
        {!! Form::open([
            'route'       => ['goal-challenges.destroy', $id],
            'method'      => 'delete',
            'data--submit'=> "gc{$id}"
        ]) !!}
        {!! Form::close() !!}
