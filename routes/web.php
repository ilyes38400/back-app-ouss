...
use App\Http\Controllers\GoalChallengeController;
use App\Http\Controllers\HomeInformationController;
use App\Http\Controllers\MentalPreparationController;
use App\Http\Controllers\NutritionElementController;
...
Route::group(['middleware' => [ 'auth', 'useractive' ]], function () {
    ...
    Route::resource('nutrition-elements', NutritionElementController::class);
    ...
    Route::resource('goal-challenges', GoalChallengeController::class);
